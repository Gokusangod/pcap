...
// NOTE - NUMBER OF PROCESSES = 6 for this example (one root and 5 slave).
// Sample I/O:

// Running root process 0 and sending to 5 processes.
// Enter an integer value: 10
// Final value received by root process: 15